package com.xl0e.tapestry.web.services.modules;
...
import com.xl0e.tapestry.security.SecurityModule;
import com.xl0e.tapestry.validate.FileExtensionValidator;
import com.xl0e.tapestry.validate.NonLatinCharsValidator;
import com.xl0e.tapestry.web.services.AlertManagerExt;
import com.xl0e.tapestry.web.services.AlertManagerExtImpl;
import com.xl0e.tapestry.web.services.CookieService;
import com.xl0e.tapestry.web.services.CustomHttpResponse;
import com.xl0e.tapestry.web.services.EmailRegexpAndHostValidator;
import com.xl0e.tapestry.web.services.RequestMessagesPipeline;
import com.xl0e.tapestry.web.services.ToolsService;
import com.xl0e.tapestry.web.services.annotation.GetParamTransformer;
import com.xl0e.tapestry.web.services.annotation.LongCacheTransformer;
