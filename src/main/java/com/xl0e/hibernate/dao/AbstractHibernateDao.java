...
public class AbstractHibernateDao<Id extends Serializable, Entity extends IModel<Id>> {
	...
	public long countByFilter(final EntityFilter filter) {
		return (Long) filter
				.setCriteria(getSession().createCriteria(entityClass).setProjection(Projections.rowCount()),
						entityClass)
				.uniqueResult();
	}
	...
	@SuppressWarnings("unchecked")
	public static <I extends Serializable, E extends IModel<I>, D extends AbstractHibernateDao<I, E>> D getDao(
			Class<?> entityClass) {
