package com.xl0e.tapestry.web.config;
...
import com.xl0e.tapestry.web.filter.LogFilter;
import com.xl0e.tapestry.web.filter.RequestInterceptorFilter;
import com.xl0e.tapestry.web.filter.StaticInterceptorFilter;
import com.xl0e.tapestry.web.filter.UploadFilter;
import com.xl0e.tapestry.web.services.ContextRegistryTapestryFilter;
